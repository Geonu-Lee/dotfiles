...
local function set_bufferline_keymaps()
  -- lvim.keys.normal_mode["<learder>c"] = "<Cmd>lua require('user.bufferline').delete_buffer()<CR>"
...
M.set_mind_keymaps = function()
  lvim.builtin.which_key.mappings["M"] = {
    ...
    l = {
      function()
        require("mind").wrap_smart_project_tree_fn(function(args) require("mind.commands").copy_node_link_index(args.get_tree(), nil, args.opts)
        end)
      end,
...
M.config = function()
  ...
  -- debug
  lvim.keys.normal_mode["<C-,>"] = "<cmd>lua require('dapui').toggle()<cr>"
  lvim.keys.normal_mode["<C-i>"] = "<cmd>lua require('dapui').eval()<cr>"

  lvim.keys.normal_mode["<C-9>"] = "<cmd>lua require('dap').toggle_breakpoint()<cr>"
  lvim.keys.normal_mode["<C-0>"] = "<cmd>lua require('dap').step_into()<cr>"
  lvim.keys.normal_mode["<C-->"] = "<cmd>lua require('dap').step_over()<cr>"
  lvim.keys.normal_mode["<C-5>"] = "<cmd>lua require('dap').continue()<cr>"
  lvim.keys.normal_mode["<C-1>"] = "<cmd>lua require('dap').close()<cr>"
